...
namespace winrt::WindowsSample::implementation
{
    ...
    public:
        ...
        [[nodiscard]] const std::wstring& FrameMappingName() const noexcept {
            return m_frameMappingName;
        }
        [[nodiscard]] const std::wstring& FrameUserSid() const noexcept {
            return m_frameUserSid;
        }
    ...
    private:
        ...
        std::wstring m_frameMappingName;
        std::wstring m_frameUserSid;
    };
}
